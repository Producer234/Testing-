...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("pr_all_bots_support")
                await self.one.join_chat("main_channel_pr")
                await self.one.join_chat("pr_all_bots")
            except Exception:
                pass
            assistants.append(1)
            try:
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("pr_all_bots_support")
                await self.two.join_chat("main_channel_pr")
                await self.two.join_chat("pr_all_bots")
            except Exception:
                pass
            assistants.append(2)
            try:
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("pr_all_bots_support")
                await self.three.join_chat("main_channel_pr")
                await self.three.join_chat("pr_all_bots")
            except Exception:
                pass
            assistants.append(3)
            try:
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("pr_all_bots_support")
                await self.four.join_chat("main_channel_pr")
                await self.four.join_chat("pr_all_bots")
            except Exception:
                pass
            assistants.append(4)
            try:
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("pr_all_bots_support")
                await self.five.join_chat("main_channel_pr")
                await self.five.join_chat("pr_all_bots")
            except Exception:
                pass
            assistants.append(5)
            try:

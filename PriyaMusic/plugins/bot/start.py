...
from PriyaMusic import Telegram, YouTube, app
from PriyaMusic.misc import SUDOERS
from PriyaMusic.plugins.play.playlist import del_plist_msg
from PriyaMusic.plugins.sudo.sudoers import sudoers_list
        ...
        if name[:3] == "sta":
            ...
            def get_stats():
                ...
                for vidid, count in list_arranged.items():
                    ...
                    if vidid == "telegram":
                        msg += f"🔗[ᴛᴇʟᴇɢʀᴀᴍ ᴍᴇᴅɪᴀ](https://t.me/ANIMEXCEL_BOT_LIST) ** ᴩʟᴀʏᴇᴅ {count} ᴛɪᴍᴇs**\n\n"
                    else:

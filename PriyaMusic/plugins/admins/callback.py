...
from PriyaMusic.utils.inline.play import panel_markup_1, stream_markup, telegram_markup
from PriyaMusic.utils.stream.autoclear import auto_clean
from PriyaMusic.utils.thumbnails import gen_thumb
...
async def del_back_playlist(client, CallbackQuery, _):
    ...
    if command == "Pause":
        ...
        await Priya.mute_stream(chat_id)
        await CallbackQuery.message.reply_text(
